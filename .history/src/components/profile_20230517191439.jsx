          ...
          <div className="profile5">
            ...
            <div className="profilepass">
              ...
              <p>Password</p>
                ...
                />
                <button style={{width : '100px' , backgroundColor : '#D93032' , color : '#fff' , border : '1px solid #D93032 '}}>Edit</button>
              </div>
              <div className="passr">
            ...
            <div className="profileitm">
              ...
              <div className="itm2">
                ...
                <button className="s" onClick={handleClick}>Save</button>
              </div>
            </div>
          </div>
        </div>
