      ...
      <div className="dashcont">
        ...
        <div className="dashright">
          ...
          <div className="dashtop">
            ...
            <div className="dashtopitem" style={{ backgroundColor: "#00C894" }}>
              <img src={img4} alt="" />
              <p>Audit Reviewed</p>
            </div>
            <div className="dashtopitem" style={{ backgroundColor: "#7A30D9" }}>
              <img src={img9} alt="" />
          ...
          <img
            ...
            src={img2}
            alt=""
            style={{ width: "98%" , display : 'block' , margin : 'auto'  , marginTop : '20px'  , marginBottom : '20px'}}
          />
          ...
          <img
            ...
            src={img2}
            alt=""
            style={{ width: "90%" , display : 'block' , margin : 'auto'  , marginTop : '20px'  , marginBottom : '20px'}}
          />
