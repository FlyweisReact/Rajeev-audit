...
const TotalCheck = ()=>{
    ...
    const url = "https://63munf68y8.execute-api.ap-south-1.amazonaws.com/dev/api/v1/CheckSheet/admin/getAll/checkSheet";
    ...
    const searchData = !query ? checksh :
            checksh?.filter((item)=>{
                return item?.nameOfCheckSheet?.toLowerCase()?.includes(query?.toLowerCase());
            })
                ...
                <div className="dashright">
                    ...
                    <div className="totalchcont">
                        ...
                        <div className="totalchcont2">
                            <input type="text" alt="" placeholder="Search By name"
                                            ...
                                            searchData?.map((ele,i)=>{
                                                return (
                                                    <tr>
                                                        ...
                                                        <td><button className="tcbtn" 
                                                            onClick={()=>handleClick(ele?.siteId,ele?._id)}
                                                        >Create Checksheet</button></td>
                                                    </tr>
                                                )
                                            })
                                        }
